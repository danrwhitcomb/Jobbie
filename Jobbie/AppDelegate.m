...
//  Jobbie
//
//  Created by Daniel Whitcomb on 1/19/13.
//  Copyright (c) 2013 Jobbie. All rights reserved.
//

#import "AppDelegate.h"

#import "Classes/ViewControllers/MainViewController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //Get storyboard and MainViewController
    self.viewController = [[UIStoryboard storyboardWithName:@"Main_iPhone" bundle: nil] instantiateViewControllerWithIdentifier:@"NavController"];
